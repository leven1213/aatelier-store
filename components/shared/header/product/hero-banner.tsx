        ...
        <div key={product.id} className="absolute inset-0">
          <Link href={`/product/${product.slug}`}>
            <div className="relative w-full h-full overlay">
              ...
              {/* Gradient */}
              <div className="absolute inset-0 bg-gradient-to-t from-black/90 via-transparent z-2" />
              ...
              {/* Blurb content */}
              <div className="w-full absolute bottom-0 px-5 py-20 lg:px-24 lg:py-20 text-left text-white z-3 max-w-[1200px] mx-auto">
