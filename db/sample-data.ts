const sampleData = {
  products: [
    ...
    },
    {
      ...
      description: 'Crafted from 100% cotton for premium comfort and breathability',
      images: [
    ...
    },
    {
      ...
      description: 'Casual chic in a semi-sheer viscose-blend long-sleeved blouse',
      images: [
    ...
    },
    {
      ...
      description: 'Feel confident in a shirt-style long dress cinched with a waist belt',
      images: [
    ...
    },
    {
      ...
      description: 'Powerful jet-black blazer with welt pockets during business hours',
      images: [
    ...
    },
    {
      ...
      category: "Women's Dresses",
      description: 'Feel like heaven in an off shoulder mini dress with draping panels',
      images: [
